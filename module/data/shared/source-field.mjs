...
export default class SourceField extends SchemaField {
  ...
  static prepareData(uuid) {
    ...
    this.bookPlaceholder = collection?.metadata?.flags?.["varlyn-dnd5e"]?.sourceBook ?? SourceField.getModuleBook(pkg) ?? "";
  ...
  static getModuleBook(pkg) {
    if ( !pkg ) return null;
    const sourceBooks = pkg.flags?.["varlyn-dnd5e"]?.sourceBooks;
