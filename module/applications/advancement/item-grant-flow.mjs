...
export default class ItemGrantFlow extends AdvancementFlow {
  ...
  async getContext() {
    ...
    const added = this.retainedData?.items.map(i => foundry.utils.getProperty(i, "flags.varlyn-dnd5e.sourceId"))
  ...
  async _updateObject(event, formData) {
    const retainedData = this.retainedData?.items.reduce((obj, i) => {
      obj[foundry.utils.getProperty(i, "flags.varlyn-dnd5e.sourceId")] = i;
      return obj;
    }, {});
