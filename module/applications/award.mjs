...
export default class Award extends Application5e {
  ...
  async _prepareContext(options) {
    ...
    context.hideXP = game.settings.get("varlyn-dnd5e", "levelingMode") === "noxp";
  ...
  _saveDestinations(destinations) {
    ...
    target.setFlag("varlyn-dnd5e", "awardDestinations", destinations);
  }
  ...
  static async handleAward(message) {
    ...
    try {
      ...
      // Otherwise show the UI with defaults
        ...
        const savedDestinations = game.user.getFlag("varlyn-dnd5e", "awardDestinations");
